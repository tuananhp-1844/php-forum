            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form class="form-style form-style-2" method="GET" action="{{ route('questions.create') }}">
                        <p>
                            <textarea rows="4" id="question_title" readonly
                                onfocus="if(this.value=={{ __('Ask any question and you be sure find your answer ?') }})this.value='';"
                                onblur="if(this.value=='')this.value={{ __('Ask any question and you be sure find your answer ?') }};">{{ __('Ask any question and you be sure find your answer ?') }}</textarea>
    ...
    <div class="widget widget_highest_points">
        ...
        <ul>
            ...
            <li>
                ...
                <h6><a href="#">{{ __('vbegy') }}</a></h6>
                <span class="comment">10 {{ __('Points') }}</span>
            </li>
            <li>
                <div class="author-img">
                    <a href="#"><img width="60" height="60" src="../../ask-me/images/demo/avatar.png" alt=""></a>
                </div>
                <h6><a href="#">{{ __('ahmed') }}</a></h6>
                <span class="comment">5 {{ __('Points') }}</span>
            </li>
        </ul>
    </div>
